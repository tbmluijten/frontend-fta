    ...
    >
      <Container>
        <div className="mx-auto max-w-[768px] text-center">
          ...
          <h2
            id="cases-heading"
            className="mt-4 text-[32px] font-bold leading-none tracking-tight text-[#0F105F]"
          >
            Cases We Handle
          </h2>
        ...
        <div className="mt-12 flex flex-col items-center gap-4 text-center">
          ...
          <p className="text-[16px] text-text-muted mt-4">
            We are always helping survivors seek justice while{' '}
            <span className="font-medium text-primary-green">connecting</span>{' '}
            them with the{' '}
            <span className="font-bold text-[#0F105F]">support they deserve</span>
            .
          </p>
        </div>
      </Container>
